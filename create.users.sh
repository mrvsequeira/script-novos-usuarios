...
echo "Dando inicio a criação do Script.sh uma Estrutura de Usuarios, Diretórios e Permissões." 

echo "O comando abaixo irá criar os seguintes diretórios: o publico, adm, ven e sec."

mkdir publico/ adm/ ven/ sec/

echo "O comando abaixo irá criar os grupos: GRP_ADM, GRP_VEN e GRP_SEC."

groupadd GRP_ADM
groupadd GRP_VEN
groupadd GRP_SEC

echo "Agora daremos permissão total para o diretório publico."

chmod 777 publico/

echo "iniciando a criação dos usuários e adicionados nos seus respectivos grupos."
